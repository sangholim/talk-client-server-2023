...
class Oauth2Controller {
    ...
    fun oauth2Login(@RegisteredOAuth2AuthorizedClient("sso") authorizedClient: OAuth2AuthorizedClient, request: HttpServletRequest, response: HttpServletResponse) {
        ...
        response.sendRedirect(Oauth2Constant.SUCCESS_URL)
    }
}